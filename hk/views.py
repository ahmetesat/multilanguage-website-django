...
def article_page(request):
    try:
        ...
        if request.method == 'GET':
            ...
            article_info = Article_Translation.objects.filter(
                website_language__language=selected_language)  # .values("name","pub_year","article__article_language__language","article__name")
            if not article_info:
                #     language = "en" #if selected_language == "tr" else "tr"
                article_info = Article_Translation.objects.filter(website_language__language="tr").values("name",
                                                                                                          "pub_year",
                                                                                                          "article__article_language__language",
                                                                                                          "article__name_bsc")
...
def course_page(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, "courses.html",
                      {"base_academic_life": "base_academic_life.html", "academic_info": course_info})
